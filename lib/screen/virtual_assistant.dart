    ...
    try {
      final response = await http.post(
        ...
        body: jsonEncode({
          ...
          "messages": [
            {"role": "system", "content": "You are DocBuddy, a professional virtual doctor. Provide short, precise and complete medical advice in a brief manner, avoiding unnecessary details."},
              ...
              itemBuilder: (context, index) {
                ...
                return Align(
                  ...
                  child: Container(
                    ...
                    style: TextStyle(color: isUser ? Colors.white : Colors.black), // User text: White, Bot text: Black
                  ),
                  ),
                );
              },
